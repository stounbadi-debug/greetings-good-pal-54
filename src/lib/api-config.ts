...
class APIConfigManager {
  ...
  constructor() {
    this.config = {
      tmdb: {
        apiKey: (typeof process !== 'undefined' ? process.env.NEXT_PUBLIC_TMDB_API_KEY : import.meta.env.VITE_TMDB_API_KEY) || '036c205f43b82d159d2f14d54e074b23',
        baseUrl: 'https://api.themoviedb.org/3'
      },
      scrapingBee: {
        apiKey: (typeof process !== 'undefined' ? process.env.NEXT_PUBLIC_SCRAPINGBEE_API_KEY : import.meta.env.VITE_SCRAPINGBEE_API_KEY) || 'Q7IUIGECHH79FWPMIXARKKLES37JV8MVEWJXINIXCJNJDZTKKDZ0YYE1JD6ZEI7T16RBBKUAODRNRSVH',
      ...
      ollama: {
        baseUrl: (typeof process !== 'undefined' ? process.env.NEXT_PUBLIC_OLLAMA_BASE_URL : import.meta.env.VITE_OLLAMA_BASE_URL) || 'http://localhost:11434/api',
        model: (typeof process !== 'undefined' ? process.env.NEXT_PUBLIC_OLLAMA_MODEL : import.meta.env.VITE_OLLAMA_MODEL) || 'llama3.2:3b'
      }
    };
  }
